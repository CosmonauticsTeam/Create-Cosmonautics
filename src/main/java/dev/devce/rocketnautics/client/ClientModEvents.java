...
public class ClientModEvents {
    ...
    public static void onRegisterKeyMappings(RegisterKeyMappingsEvent event) {
        ...
        event.register(RocketNauticsClient.JETPACK_ROLL_LEFT);
        event.register(RocketNauticsClient.JETPACK_ROLL_RIGHT);
    }
    ...
    public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        event.registerLayerDefinition(
                JetpackSlimModel.LAYER_LOCATION,
                JetpackSlimModel::createBodyLayer
        );

        event.registerLayerDefinition(
                JetpackModel.LAYER_LOCATION,
                JetpackModel::createBodyLayer
        );
    }
    @SubscribeEvent
