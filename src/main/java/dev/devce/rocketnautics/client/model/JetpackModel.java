...
public class JetpackModel<T extends Entity> extends EntityModel<T> implements IJetpackModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("rocketnautics", "jetpack"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition jetpack_arm_L = root.addOrReplaceChild("jetpack_arm_L", CubeListBuilder.create().texOffs(26, 49).addBox(-9.5F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.01F))
				.texOffs(26, 44).addBox(-11.0F, 1.0F, 1.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.26F))
				.texOffs(41, 39).addBox(-11.5F, 0.5F, 2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.01F))
				.texOffs(25, 36).addBox(-11.0F, -4.0F, 1.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.265F)), PartPose.offsetAndRotation(-8.0F, 2.0F, 3.0F, 0.0f, (float)Math.toRadians(180.0f), 0.0f));
		...
		PartDefinition jetpack_arm_R = root.addOrReplaceChild("jetpack_arm_R", CubeListBuilder.create().texOffs(26, 49).mirror().addBox(7.5F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.01F)).mirror(false)
				.texOffs(26, 44).mirror().addBox(7.0F, 1.0F, 1.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.26F)).mirror(false)
				.texOffs(41, 39).mirror().addBox(10.5F, 0.5F, 2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.01F)).mirror(false)
				.texOffs(25, 36).mirror().addBox(7.0F, -4.0F, 1.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.265F)).mirror(false), PartPose.offsetAndRotation(8.0F, 2.0F, 3.0F, 0.0f, (float)Math.toRadians(180.0f), 0.0f));
