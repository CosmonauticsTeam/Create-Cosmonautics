...
public class RocketBlocks {
    ...
    public static final BlockEntry<dev.devce.rocketnautics.content.blocks.ion.IonEngineBlock> ION_ENGINE = REGISTRATE.block("ion_engine", dev.devce.rocketnautics.content.blocks.ion.IonEngineBlock::new)
            .initialProperties(() -> Blocks.IRON_BLOCK)
            .properties(BlockBehaviour.Properties::noOcclusion)
            .transform(pickaxeOnly())
            .tag(RocketTags.BlockTags.THRUSTERS.tag, RocketTags.BlockTags.LIGHT.tag, RocketTags.BlockTags.QUARTER_VOLUME.tag)
